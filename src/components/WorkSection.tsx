      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            {/* Image container */}
            <div className="relative overflow-hidden rounded-sm border border-primary/50">
              <img
    ...
    <>
      ...
      >
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
          {/* Image */}
          <div 
            className="relative overflow-hidden rounded-sm border border-primary/50 cursor-pointer transition-all duration-300 hover:border-primary hover:shadow-lg hover:shadow-primary/5 hover:-translate-y-1"
